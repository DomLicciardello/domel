...
export default function Home() {
  return (
    ...
    <h1 className='text-2 mt-2'>Domenico Library <span style={{fontSize:'1.8rem', color:'#333333', background:'#F8C80B', padding:'2px 10px', borderRadius:'20px 5px 20px 5px'}}>v1.0</span></h1>
